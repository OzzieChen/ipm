...
public class FileController {
    ...
    public String errorOccur(HttpServletRequest req,
    ...
    public Resp<?> importPOST(HttpServletRequest request,
                              @RequestParam("file") MultipartFile fileUp,
        ...
        try {
            File dir = new File(rootPath + File.separator + "txts" + File.separator);
            if (!dir.exists()) {
                dir.mkdir();
            }
            fileServer = new File(rootPath + File.separator + "txts" + File.separator +
    ...
    public Resp<?> importPOST2(HttpServletRequest request) {
        ...
        try {
            ...
            fileServer = new File(rootPath + File.separator + "txts" + File.separator +
                    ...
                    fname + ".txt" : System.currentTimeMillis() + ".txt"));
